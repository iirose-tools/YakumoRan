...
import { MoveToRoom } from './decoder/MoveToRoom';
...
interface BotEvent {
  ...
  on(event: 'MoveToRoom', listener: (msg: MoveToRoom) => void): void;
  ...
  once(event: 'MoveToRoom', listener: (msg: MoveToRoom) => void): void;
  ...
  removeAllListeners(event: 'MoveToRoom'): void
