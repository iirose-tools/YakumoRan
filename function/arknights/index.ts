...
if (!per.users.hasPermission('function', 'function.arknights')) {
  api.command(/^查物品(.*)$/, 'arknights.query.item', async (m, e, reply) => {
  ...
  api.command(/^查掉落(.*)$/, 'arknights.query.drops', async (m, e, reply) => {
